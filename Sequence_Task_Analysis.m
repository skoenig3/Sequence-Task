...
%%
%%---[1] Extract Eye Data from Cortex Files and Detect Fixations and Saccades with Cluster Fix---%%
% sequence_cortex_files = {'PW140623.4','PW140625.4','PW140626.4','PW140627.4',...
%     'PW140710.3'};
% calibration_cortex_files = {{'PW140623.1','PW140623.3'},{'PW140625.1','PW140625.3'},...
%     {'PW140626.1','PW140626.3'},{'PW140627.1','PW140627.3'} 'PW140710.1'};
% item_number = [16 17 18 19 20];
% number_calibration_points = [63 63 63 63 25];
% 
...
fixation_files = fixation_files(end)
...
%%
all_reaction_time = cell(1,100); %how long after a stimulus disappears do they saccade
all_time_to_fixation = cell(1,100); %how fast did they get to it the first time around
all_fixation_accuracy = cell(1,100); %how far off
all_fixation_duration = cell(1,100); %fixation duration
all_fixation_on_test = cell(1,100); %how long the stimulus was on while fixating
all_extrafixations = cell(1,100); %how many noncross hair fixations do they make
