...
% item_letter = ['M','N','O','P','Q','R','S'];
% number_calibration_points = [25 25 25 25 25 25 25];


calibration_cortex_files = {'PW140723.1','PW140813.1','PW140814.1','PW140815.1',...
'PW140821.1','PW141030.1'};
sequence_cortex_files = {'PW140723.2','PW140813.4','PW140814.4','PW140815.3',...
'PW140821.3','PW141030.4'};
item_letter = ['Q','S','T','U','V','X'];
number_calibration_points = [25 25 25 25 25 25 25];
% 
% for file = 2:length(sequence_cortex_files)-1;
